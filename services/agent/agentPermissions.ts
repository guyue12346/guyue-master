...
export const AGENT_PERMISSION_MODULES: { key: string; label: string; desc: string }[] = [
  ...
  { key: 'leetcode', label: '题单', desc: 'LeetCode 题单、分组、题目和完成进度' },
  { key: 'code', label: 'Code', desc: '编码练习分类、分类笔记、练习和练习文件' },
  { key: 'question-bank', label: '题库', desc: '题库分类、题目、题单和解题方法' },
  { key: 'canvas', label: '画布', desc: '画布库、画布分类和绘图元数据' },
  { key: 'git', label: 'Git管理', desc: '本地 Git 仓库状态、提交、暂存、拉取和推送' },
  { key: 'files', label: '文件', desc: '已授权文件分类内的查询和读取' },
  { key: 'knowledge', label: '知识库', desc: '本地知识库索引构建和语义检索' },
  { key: 'web', label: '联网搜索', desc: '网页搜索、GitHub/npm/StackOverflow/arXiv 专用搜索' },
