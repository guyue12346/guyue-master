...
import {
  runAgentSpecializedSearch,
  runAgentWebOpen,
  runAgentWebSearch,
  type AgentSpecializedSearchParams,
  type AgentWebOpenParams,
  type AgentWebSearchParams,
} from './agentSearch.js';
...
ipcMain.handle('agent-web-search', async (_, rawParams: AgentWebSearchParams) => {
  return runAgentWebSearch(rawParams);
});

ipcMain.handle('agent-web-open', async (_, rawParams: AgentWebOpenParams) => {
  return runAgentWebOpen(rawParams);
});

ipcMain.handle('agent-specialized-search', async (_, rawParams: AgentSpecializedSearchParams) => {
  return runAgentSpecializedSearch(rawParams);
});
