...
export const DEFAULT_MODULE_CONFIG: ModuleConfig[] = [
  ...
  { id: 'prompts',      name: 'Skills/MCP', enabled: true, priority: 1, icon: 'Sparkles',      shortcut: 'Tab+8' },
  { id: 'todo',         name: '任务与日程', enabled: true, priority: 2,  icon: 'ListTodo',      shortcut: 'Tab+5' },
  { id: 'datacenter',   name: '数据中心',  enabled: true, priority: 3,  icon: 'BarChart3',     shortcut: 'Tab+D' },
  { id: 'spaces',       name: '空间',      enabled: true, priority: 4,  icon: 'PanelsTopLeft',  shortcut: 'Tab+K' },
  { id: 'practice',     name: '刷题',      enabled: true, priority: 5,  icon: 'Code2',         shortcut: 'Tab+L' },
  { id: 'git',          name: 'Git管理',   enabled: true, priority: 6,  icon: 'GitBranch',     shortcut: 'Tab+G' },
  { id: 'terminal',     name: '本地终端',  enabled: false, priority: 7,  icon: 'Terminal',      shortcut: 'Tab+0' },
  { id: 'files',        name: '文件管理',  enabled: true, priority: 8,  icon: 'FolderOpen',    shortcut: 'Tab+6' },
  { id: 'latex',        name: 'LaTeX编辑器', enabled: true, priority: 9, icon: 'FileType2',    shortcut: 'Tab+X' },
  { id: 'excalidraw',   name: '绘图板',    enabled: true, priority: 10,  icon: 'Pencil',        shortcut: 'Tab+E' },
  { id: 'image-hosting', name: '图床管理', enabled: true, priority: 11, icon: 'Image',         shortcut: 'Tab+I' },
  { id: 'question-bank', name: '题库',     enabled: true, priority: 12, icon: 'BookOpenCheck', shortcut: 'Tab+Q' },
  { id: 'browser',      name: '内置浏览器', enabled: false, priority: 13, icon: 'Globe',       shortcut: 'Tab+B' },
  ...
  { id: 'notes',        name: '便签',      enabled: true, priority: 17, icon: 'StickyNote',     shortcut: 'Tab+2' },
  { id: 'workflow',       name: '工作流引擎', enabled: false, priority: 18, icon: 'Workflow',    shortcut: 'Tab+W' },
];
