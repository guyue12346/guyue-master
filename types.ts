...
export const DEFAULT_MODULE_CONFIG: ModuleConfig[] = [
  ...
  { id: 'todo',         name: '任务与日程', enabled: true, priority: 1,  icon: 'ListTodo',      shortcut: 'Tab+5' },
  ...
  { id: 'terminal',     name: '本地终端',  enabled: false, priority: 6,  icon: 'Terminal',      shortcut: 'Tab+0' },
  { id: 'files',        name: '文件管理',  enabled: true, priority: 7,  icon: 'FolderOpen',    shortcut: 'Tab+6' },
  { id: 'latex',        name: 'LaTeX编辑器', enabled: true, priority: 8, icon: 'FileType2',    shortcut: 'Tab+X' },
